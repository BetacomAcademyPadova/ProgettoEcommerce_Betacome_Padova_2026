...
public class StatoOrdineTest {
	...
	public void deleteTest() throws Exception{
		...
		mockMvc.perform(delete("/rest/StatoOrdine/delete/" +  "Test Delete"))
	            .andExpect(status().isOk())
	...
	public void updateTest() throws Exception{
		StatoOrdineReq req = new StatoOrdineReq();
		req.setStato("updated");
		mockMvc.perform(patch("/rest/StatoOrdine/update/"+4)
	            .contentType(MediaType.APPLICATION_JSON)
	            .content(objectMapper.writeValueAsString(req)))
	        .andExpect(status().isOk());
	}
	...
	public void listAllTest() throws Exception{
		...
		MvcResult result = mockMvc.perform(get("/rest/StatoOrdine/getAll"))
	            .andExpect(status().isOk())
	            .andReturn();
		  
		String json = result.getResponse().getContentAsString();
		List<StatoOrdineDTO> lR = objectMapper.readValue(json, new TypeReference<List<StatoOrdineDTO>>() {});
